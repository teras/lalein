...
class ParameterTest {
    ...
    void constructor_nullOther_becomesEmptyString() {
        ...
        assertEquals("", p.resolve(NEVER, null, null, new Object[]{5}));
    }

    @Test
    void resolve_nullArgsArray_throws() {
        Parameter p = param(1, null, "one", null, null, null, "other");
        assertThrows(LaleinException.class, () -> p.resolve(NEVER, null, null, null));
    }

    @Test
    void resolve_emptyArgsArray_throws() {
        Parameter p = param(1, null, "one", null, null, null, "other");
        assertThrows(LaleinException.class, () -> p.resolve(NEVER, null, null, new Object[0]));
    }
    ...
    void resolve_argsTooShortForIndex_throws() {
        ...
        LaleinException ex = assertThrows(LaleinException.class,
                () -> p.resolve(NEVER, null, null, new Object[]{1, 2}));
        assertTrue(ex.getMessage().contains("#3"));
        assertTrue(ex.getMessage().contains("2 arguments were given"));
    }
    ...
    void resolve_singleArgMessageUsesSingular() {
        ...
        LaleinException ex = assertThrows(LaleinException.class,
                () -> p.resolve(NEVER, null, null, new Object[]{1}));
        assertTrue(ex.getMessage().contains("1 argument was given"));
    }
    ...
    void resolve_nullArg_throws() {
        Parameter p = param(1, null, "one", null, null, null, "other");
        LaleinException ex = assertThrows(LaleinException.class,
                () -> p.resolve(NEVER, null, null, new Object[]{null}));
    ...
    void resolve_nonNumberArg_throws() {
        Parameter p = param(1, null, "one", null, null, null, "other");
        LaleinException ex = assertThrows(LaleinException.class,
                () -> p.resolve(NEVER, null, null, new Object[]{"five"}));
    ...
    void resolve_naturalZero_whenZeroDefined() {
        ...
        assertEquals("no apples", p.resolve(NEVER, null, null, new Object[]{0}));
    }

    @Test
    void resolve_naturalZero_fallsToOther_whenZeroAbsent() {
        Parameter p = param(1, null, "one apple", null, null, null, "%d apples");
        assertEquals("%d apples", p.resolve(NEVER, null, null, new Object[]{0}));
    }

    @Test
    void resolve_naturalOne() {
        Parameter p = param(1, null, "one apple", null, null, null, "%d apples");
        assertEquals("one apple", p.resolve(NEVER, null, null, new Object[]{1}));
    }

    @Test
    void resolve_naturalTwo() {
        Parameter p = param(1, null, null, "two apples", null, null, "%d apples");
        assertEquals("two apples", p.resolve(NEVER, null, null, new Object[]{2}));
    }

    @Test
    void resolve_naturalTwo_fallsToOther_whenTwoAbsent() {
        Parameter p = param(1, null, null, null, null, null, "%d apples");
        assertEquals("%d apples", p.resolve(NEVER, null, null, new Object[]{2}));
    }

    @Test
    void resolve_picksSecondArgWhenIndexIsTwo() {
        Parameter p = param(2, "no oranges", "one orange", null, null, null, "%2$d oranges");
        assertEquals("no oranges", p.resolve(NEVER, null, null, new Object[]{5, 0}));
        assertEquals("one orange", p.resolve(NEVER, null, null, new Object[]{5, 1}));
        assertEquals("%2$d oranges", p.resolve(NEVER, null, null, new Object[]{5, 7}));
    }
    ...
    void resolve_customResolverProducesFew() {
        ...
        assertEquals("FEW", p.resolve(fewForThree, null, null, new Object[]{3}));
    }
    ...
    void resolve_customResolverProducesMany() {
        ...
        assertEquals("MANY", p.resolve(manyForFive, null, null, new Object[]{5}));
    }

    @Test
    void resolve_resolverReturnsNull_fallsToOther() {
        Parameter p = param(1, "z", "o", null, null, null, "DEFAULT");
        assertEquals("DEFAULT", p.resolve(NEVER, null, null, new Object[]{7}));
    }
    ...
    void resolve_resolverReturnsCategoryButThatFormIsAbsent_fallsToOther() {
        ...
        assertEquals("FALLBACK", p.resolve(alwaysFew, null, null, new Object[]{42}));
    }
    ...
    void resolve_naturalBeatsRuleBasedAtExactBoundary() {
        ...
        assertEquals("zeroForm", p.resolve(alwaysOne, null, null, new Object[]{0}));
    }
    ...
    void resolve_zeroBandIncludesNegativeTinyValues() {
        ...
        assertEquals("z", p.resolve(NEVER, null, null, new Object[]{-0.0000005d}));
    }
